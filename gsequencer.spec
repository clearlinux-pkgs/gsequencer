...
Version  : 5.3.6
Release  : 75
URL      : https://download.savannah.nongnu.org/releases/gsequencer/5.3.x/gsequencer-5.3.6.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/5.3.x/gsequencer-5.3.6.tar.gz
...
%prep
%setup -q -n gsequencer-5.3.6
cd %{_builddir}/gsequencer-5.3.6
pushd ..
cp -a gsequencer-5.3.6 buildavx2
popd
pushd ..
cp -a gsequencer-5.3.6 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686580556
...
/usr/share/xml/gsequencer/schema/dtd/5.3.6/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.6/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.6/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.6/ags_simple_file.dtd
