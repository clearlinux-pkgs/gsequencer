...
Version  : 4.4.2
Release  : 64
URL      : https://download.savannah.nongnu.org/releases/gsequencer/4.4.x/gsequencer-4.4.2.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/4.4.x/gsequencer-4.4.2.tar.gz
...
%prep
%setup -q -n gsequencer-4.4.2
cd %{_builddir}/gsequencer-4.4.2
pushd ..
cp -a gsequencer-4.4.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663686186
...
/usr/share/xml/gsequencer/schema/dtd/4.4.2/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.4.2/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.4.2/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.4.2/ags_simple_file.dtd
