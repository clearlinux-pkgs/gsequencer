...
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/7.6.x/gsequencer-7.6.3.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/7.6.x/gsequencer-7.6.3.tar.gz.sig
...
%setup -q -n gsequencer-7.6.3
cd %{_builddir}/gsequencer-7.6.3
pushd ..
cp -a gsequencer-7.6.3 buildavx2
popd
pushd ..
cp -a gsequencer-7.6.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737995849
...
/usr/share/xml/gsequencer/schema/dtd/7.6.3/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.6.3/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.6.3/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.6.3/ags_simple_file.dtd
