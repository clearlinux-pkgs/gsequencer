...
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/7.2.x/gsequencer-7.2.9.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/7.2.x/gsequencer-7.2.9.tar.gz.sig
...
%setup -q -n gsequencer-7.2.9
cd %{_builddir}/gsequencer-7.2.9
pushd ..
cp -a gsequencer-7.2.9 buildavx2
popd
pushd ..
cp -a gsequencer-7.2.9 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731686389
...
/usr/share/xml/gsequencer/schema/dtd/7.2.9/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.2.9/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.2.9/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.2.9/ags_simple_file.dtd
