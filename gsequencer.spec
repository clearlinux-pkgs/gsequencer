...
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/7.3.x/gsequencer-7.3.15.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/7.3.x/gsequencer-7.3.15.tar.gz.sig
...
%setup -q -n gsequencer-7.3.15
cd %{_builddir}/gsequencer-7.3.15
pushd ..
cp -a gsequencer-7.3.15 buildavx2
popd
pushd ..
cp -a gsequencer-7.3.15 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732296850
...
/usr/share/xml/gsequencer/schema/dtd/7.3.15/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.3.15/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.3.15/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.3.15/ags_simple_file.dtd
