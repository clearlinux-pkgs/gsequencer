...
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.7.x/gsequencer-6.7.2.tar.gz
...
%prep
%setup -q -n gsequencer-6.7.2
cd %{_builddir}/gsequencer-6.7.2
pushd ..
cp -a gsequencer-6.7.2 buildavx2
popd
pushd ..
cp -a gsequencer-6.7.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712933084
...
/usr/share/xml/gsequencer/schema/dtd/6.7.2/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.7.2/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.7.2/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.7.2/ags_simple_file.dtd
