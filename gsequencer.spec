...
Version  : 5.4.0
Release  : 79
URL      : https://download.savannah.nongnu.org/releases/gsequencer/5.4.x/gsequencer-5.4.0.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/5.4.x/gsequencer-5.4.0.tar.gz
...
%prep
%setup -q -n gsequencer-5.4.0
cd %{_builddir}/gsequencer-5.4.0
pushd ..
cp -a gsequencer-5.4.0 buildavx2
popd
pushd ..
cp -a gsequencer-5.4.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688405758
...
/usr/share/xml/gsequencer/schema/dtd/5.4.0/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.4.0/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.4.0/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.4.0/ags_simple_file.dtd
