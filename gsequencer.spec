...
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.5.x/gsequencer-6.5.2.tar.gz
...
%prep
%setup -q -n gsequencer-6.5.2
cd %{_builddir}/gsequencer-6.5.2
pushd ..
cp -a gsequencer-6.5.2 buildavx2
popd
pushd ..
cp -a gsequencer-6.5.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707957659
...
/usr/share/xml/gsequencer/schema/dtd/6.5.2/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.5.2/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.5.2/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.5.2/ags_simple_file.dtd
