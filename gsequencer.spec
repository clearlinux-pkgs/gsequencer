...
Version  : 6.12.5
Release  : 106
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.12.x/gsequencer-6.12.5.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.12.x/gsequencer-6.12.5.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/6.12.x/gsequencer-6.12.5.tar.gz.sig
...
%setup -q -n gsequencer-6.12.5
cd %{_builddir}/gsequencer-6.12.5
pushd ..
cp -a gsequencer-6.12.5 buildavx2
popd
pushd ..
cp -a gsequencer-6.12.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715818355
...
/usr/share/xml/gsequencer/schema/dtd/6.12.5/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.12.5/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.12.5/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.12.5/ags_simple_file.dtd
