...
Version  : 6.0.10
Release  : 86
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.0.x/gsequencer-6.0.10.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.0.x/gsequencer-6.0.10.tar.gz
...
%prep
%setup -q -n gsequencer-6.0.10
cd %{_builddir}/gsequencer-6.0.10
pushd ..
cp -a gsequencer-6.0.10 buildavx2
popd
pushd ..
cp -a gsequencer-6.0.10 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694183482
...
/usr/share/xml/gsequencer/schema/dtd/6.0.10/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.0.10/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.0.10/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.0.10/ags_simple_file.dtd
