...
%prep
%setup -q -n gsequencer-5.3.7
cd %{_builddir}/gsequencer-5.3.7
pushd ..
cp -a gsequencer-5.3.7 buildavx2
popd
pushd ..
cp -a gsequencer-5.3.7 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686676482
...
/usr/share/xml/gsequencer/schema/dtd/5.3.7/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.7/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.7/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.7/ags_simple_file.dtd
