...
Version  : 6.2.4
Release  : 92
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.2.x/gsequencer-6.2.4.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.2.x/gsequencer-6.2.4.tar.gz
...
%prep
%setup -q -n gsequencer-6.2.4
cd %{_builddir}/gsequencer-6.2.4
pushd ..
cp -a gsequencer-6.2.4 buildavx2
popd
pushd ..
cp -a gsequencer-6.2.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702997457
...
/usr/share/xml/gsequencer/schema/dtd/6.2.4/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.2.4/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.2.4/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.2.4/ags_simple_file.dtd
