...
Version  : 6.14.7
Release  : 111
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.14.x/gsequencer-6.14.7.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.14.x/gsequencer-6.14.7.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/6.14.x/gsequencer-6.14.7.tar.gz.sig
...
%setup -q -n gsequencer-6.14.7
cd %{_builddir}/gsequencer-6.14.7
pushd ..
cp -a gsequencer-6.14.7 buildavx2
popd
pushd ..
cp -a gsequencer-6.14.7 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721953766
...
/usr/share/xml/gsequencer/schema/dtd/6.14.7/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.14.7/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.14.7/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.14.7/ags_simple_file.dtd
