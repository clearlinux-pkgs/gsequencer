...
Version  : 6.6.0
Release  : 99
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.6.x/gsequencer-6.6.0.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.6.x/gsequencer-6.6.0.tar.gz
...
%prep
%setup -q -n gsequencer-6.6.0
cd %{_builddir}/gsequencer-6.6.0
pushd ..
cp -a gsequencer-6.6.0 buildavx2
popd
pushd ..
cp -a gsequencer-6.6.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711502867
...
/usr/share/xml/gsequencer/schema/dtd/6.6.0/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.6.0/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.6.0/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.6.0/ags_simple_file.dtd
