...
Version  : 6.3.5
Release  : 95
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.3.x/gsequencer-6.3.5.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.3.x/gsequencer-6.3.5.tar.gz
...
%prep
%setup -q -n gsequencer-6.3.5
cd %{_builddir}/gsequencer-6.3.5
pushd ..
cp -a gsequencer-6.3.5 buildavx2
popd
pushd ..
cp -a gsequencer-6.3.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705861571
...
LDFLAGS="$LDFLAGS -march=x86-64-v3 -march=x86-64-v3 "
%configure --disable-static --enable-silent-rules \
--enable-pulse \
--disable-jack
make  %{?_smp_mflags}
...
/usr/share/xml/gsequencer/schema/dtd/6.3.5/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.3.5/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.3.5/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.3.5/ags_simple_file.dtd
