...
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/5.3.x/gsequencer-5.3.12.tar.gz
...
%prep
%setup -q -n gsequencer-5.3.12
cd %{_builddir}/gsequencer-5.3.12
pushd ..
cp -a gsequencer-5.3.12 buildavx2
popd
pushd ..
cp -a gsequencer-5.3.12 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687791740
...
/usr/share/xml/gsequencer/schema/dtd/5.3.12/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.12/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.12/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.3.12/ags_simple_file.dtd
