...
Version  : 7.1.1
Release  : 125
URL      : https://download.savannah.nongnu.org/releases/gsequencer/7.1.x/gsequencer-7.1.1.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/7.1.x/gsequencer-7.1.1.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/7.1.x/gsequencer-7.1.1.tar.gz.sig
...
%setup -q -n gsequencer-7.1.1
cd %{_builddir}/gsequencer-7.1.1
pushd ..
cp -a gsequencer-7.1.1 buildavx2
popd
pushd ..
cp -a gsequencer-7.1.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730292601
...
/usr/share/xml/gsequencer/schema/dtd/7.1.1/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.1.1/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.1.1/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.1.1/ags_simple_file.dtd
