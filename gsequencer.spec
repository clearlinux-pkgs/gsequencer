...
%prep
%setup -q -n gsequencer-4.4.3
cd %{_builddir}/gsequencer-4.4.3
pushd ..
cp -a gsequencer-4.4.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667834158
...
/usr/share/xml/gsequencer/schema/dtd/4.4.3/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.4.3/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.4.3/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.4.3/ags_simple_file.dtd
