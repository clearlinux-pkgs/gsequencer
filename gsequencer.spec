...
Version  : 6.8.3
Release  : 104
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.8.x/gsequencer-6.8.3.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.8.x/gsequencer-6.8.3.tar.gz
...
%prep
%setup -q -n gsequencer-6.8.3
cd %{_builddir}/gsequencer-6.8.3
pushd ..
cp -a gsequencer-6.8.3 buildavx2
popd
pushd ..
cp -a gsequencer-6.8.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713455144
...
/usr/share/xml/gsequencer/schema/dtd/6.8.3/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.8.3/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.8.3/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.8.3/ags_simple_file.dtd
