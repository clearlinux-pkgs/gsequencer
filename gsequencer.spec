...
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/5.4.x/gsequencer-5.4.1.tar.gz
...
%prep
%setup -q -n gsequencer-5.4.1
cd %{_builddir}/gsequencer-5.4.1
pushd ..
cp -a gsequencer-5.4.1 buildavx2
popd
pushd ..
cp -a gsequencer-5.4.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688567736
...
/usr/share/xml/gsequencer/schema/dtd/5.4.1/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.4.1/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.4.1/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/5.4.1/ags_simple_file.dtd
