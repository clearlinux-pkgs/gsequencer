...
Version  : 7.1.2
Release  : 126
URL      : https://download.savannah.nongnu.org/releases/gsequencer/7.1.x/gsequencer-7.1.2.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/7.1.x/gsequencer-7.1.2.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/7.1.x/gsequencer-7.1.2.tar.gz.sig
...
%setup -q -n gsequencer-7.1.2
cd %{_builddir}/gsequencer-7.1.2
pushd ..
cp -a gsequencer-7.1.2 buildavx2
popd
pushd ..
cp -a gsequencer-7.1.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730387994
...
/usr/share/xml/gsequencer/schema/dtd/7.1.2/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.1.2/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.1.2/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.1.2/ags_simple_file.dtd
