...
Version  : 7.2.5
Release  : 131
URL      : https://download.savannah.nongnu.org/releases/gsequencer/7.2.x/gsequencer-7.2.5.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/7.2.x/gsequencer-7.2.5.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/7.2.x/gsequencer-7.2.5.tar.gz.sig
...
%setup -q -n gsequencer-7.2.5
cd %{_builddir}/gsequencer-7.2.5
pushd ..
cp -a gsequencer-7.2.5 buildavx2
popd
pushd ..
cp -a gsequencer-7.2.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731432913
...
/usr/share/xml/gsequencer/schema/dtd/7.2.5/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.2.5/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.2.5/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/7.2.5/ags_simple_file.dtd
