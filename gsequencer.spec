...
Version  : 6.13.5
Release  : 110
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.13.x/gsequencer-6.13.5.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.13.x/gsequencer-6.13.5.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/6.13.x/gsequencer-6.13.5.tar.gz.sig
...
%setup -q -n gsequencer-6.13.5
cd %{_builddir}/gsequencer-6.13.5
pushd ..
cp -a gsequencer-6.13.5 buildavx2
popd
pushd ..
cp -a gsequencer-6.13.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721952748
...
/usr/share/xml/gsequencer/schema/dtd/6.13.5/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.13.5/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.13.5/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.13.5/ags_simple_file.dtd
