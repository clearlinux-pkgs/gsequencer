...
Version  : 6.16.20
Release  : 117
URL      : https://download.savannah.nongnu.org/releases/gsequencer/6.16.x/gsequencer-6.16.20.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/gsequencer/6.16.x/gsequencer-6.16.20.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/gsequencer/6.16.x/gsequencer-6.16.20.tar.gz.sig
...
%setup -q -n gsequencer-6.16.20
cd %{_builddir}/gsequencer-6.16.20
pushd ..
cp -a gsequencer-6.16.20 buildavx2
popd
pushd ..
cp -a gsequencer-6.16.20 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723819308
...
/usr/share/xml/gsequencer/schema/dtd/6.16.20/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.16.20/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.16.20/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.16.20/ags_simple_file.dtd
