...
%prep
%setup -q -n gsequencer-4.3.4
cd %{_builddir}/gsequencer-4.3.4
pushd ..
cp -a gsequencer-4.3.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659967747
...
/usr/share/xml/gsequencer/schema/dtd/4.3.4/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.3.4/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.3.4/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/4.3.4/ags_simple_file.dtd
