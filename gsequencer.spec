...
%setup -q -n gsequencer-6.12.7
cd %{_builddir}/gsequencer-6.12.7
pushd ..
cp -a gsequencer-6.12.7 buildavx2
popd
pushd ..
cp -a gsequencer-6.12.7 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715895727
...
/usr/share/xml/gsequencer/schema/dtd/6.12.7/ags_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.12.7/ags_midi_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.12.7/ags_osc_file.dtd
/usr/share/xml/gsequencer/schema/dtd/6.12.7/ags_simple_file.dtd
